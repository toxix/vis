...
TimeStep.prototype.isMajor = function() {
  ...
  switch (this.scale) {
    ...
    case 'minute':
      // test if the majorLabel contains a an hour to be printed.
      if (/h/i.test(this.format.majorLabels.minute.replace(/\[.*?\]/, '')))
        // print majorLabels every hour
        return (this.current.getMinutes() == 0);
      else
        // print majorLabels every day
